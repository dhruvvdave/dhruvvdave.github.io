...
async function fetchGitHubData() {
    try {
        ...
        // Fetch repos for stars count and language stats
        ...
        renderLanguageChart(sortedLanguages, repos.length);
        ...
        // Set fallback values
        ['repo-count', 'stars-count', 'followers-count', 'following-count'].forEach(id => {
...
function renderLanguageChart(languages, totalRepos) {
...
function renderFeaturedRepos(repos) {
    ...
    // Get top 3 repos by stars or recent updates
